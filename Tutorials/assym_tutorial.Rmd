---
title: "Assymetric Markov Chain Tutorial"
...
We first demonstrate the multiple-try metropolis technique with the recommended settings.
...
```{r}
library(foreach)
source("../asymmetric/assym_MTM_core.R")
```
